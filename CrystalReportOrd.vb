...
Public Class CrystalReportOrd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestCabinetMedical.CrystalReportOrd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportOrd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportOrd = New CrystalReportOrd()
        rpt.Site = Me.Site
        Return rpt
    End Function
