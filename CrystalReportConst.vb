...
Public Class CrystalReportConst
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GestCabinetMedical.CrystalReportConst.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportConst
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportConst = New CrystalReportConst()
        rpt.Site = Me.Site
        Return rpt
    End Function
